...
class SincDSNet(nn.Module):
    def __init__(self):
        ...
        self.dsconv1   = DSConvBlock(80,  128, 25, 1, 1)
        self.dsconv2   = DSConvBlock(128, 128,  9, 1, 1)
        self.dsconv3   = DSConvBlock(128, 128,  9, 1, 1)
        self.dsconv4   = DSConvBlock(128, 128,  9, 1, 1)
        self.dsconv5   = DSConvBlock(128, 128,  9, 1, 1)  
